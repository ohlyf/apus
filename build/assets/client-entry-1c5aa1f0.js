...
function gs(e) {
  return (e = Uc(e)), e !== null ? ws(e) : null;
}
function ws(e) {
...
var ks = he.unstable_scheduleCallback,
  ...
  Zu = he.unstable_ImmediatePriority,
...
function Jc(e, n, t, r, l) {
  switch (n) {
    ...
    case 'gotpointercapture':
      return (
        (u = l.pointerId), It.set(u, ft(It.get(u) || null, e, n, t, r, l)), !0
      );
  }
  return !1;
}
...
var Fr = null;
function fu(e, n, t, r) {
  if (((Fr = null), (e = Gu(r)), (e = kn(e)), e !== null))
...
var vf = A({}, Zt, {
  ...
  wf = ge(gf),
  kf = A({}, ut, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  Sf = ge(kf),
  Ef = A({}, tl, {
    deltaX: function (e) {
...
function js(e) {
  if (e.propertyName === 'value' && rl(jt)) {
    var n = [];
    Is(n, jt, e, Gu(e)), hs(Tf, n);
  }
}
function Rf(e, n, t) {
  e === 'focusin'
    ? (li(), (_t = n), (jt = t), _t.attachEvent('onpropertychange', js))
    : e === 'focusout' && li();
}
function Of(e) {
...
function ll(e) {
  ...
  var n = jn[e],
    t;
  for (t in n) if (n.hasOwnProperty(t) && t in As) return (Ll[e] = n[t]);
  return e;
}
...
function vn() {
  if (!Fl && $e !== null) {
    ...
    try {
      ...
      throw ($e !== null && ($e = $e.slice(e + 1)), ks(Zu, vn), l);
    } finally {
      (O = n), (Fl = !1);
    }
  }
...
function Zs(e, n, t) {
  (we[ke++] = Ae), (we[ke++] = Ve), (we[ke++] = Pn), (Pn = e);
  var r = Ae;
  e = Ve;
  var l = 32 - Le(r) - 1;
  (r &= ~(1 << l)), (t += 1);
...
function _u(e, n, t, r) {
  var l = e.stateNode;
  (l.props = t), (l.state = e.memoizedState), (l.refs = na), po(e);
  var u = n.contextType;
  typeof u == 'object' && u !== null
    ? (l.context = Ce(u))
...
function go(e, n, t, r, l, u) {
  if (
    ...
    (n.updateQueue = null),
    (n.lanes = 0),
    (_r.current = e === null || e.memoizedState === null ? ed : nd),
    (e = t(r, l)),
    Pt)
  ) {
    u = 0;
...
function ka(e, n, t) {
  return Nn & 21
    ? (Oe(t, n) || ((t = Cs()), ($.lanes |= t), (zn |= t), (e.baseState = !0)),
      n)
  ...
  return (
    ...
    e !== null && !ae
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ke(e, n, l))
      : (j && t && uo(n), (n.flags |= 1), le(e, n, r, l), n.child)
  );
}
  ...
  return (
    ...
    e !== null && !ae
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ke(e, n, l))
      : (j && r && uo(n), (n.flags |= 1), le(e, n, t, l), n.child)
  );
}
function Li(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    Pr(e, n), ta(n, t, r), _u(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps;
    o.props = i;
    ...
    (o.state = p),
      ...
      i !== r || p !== s || ce.current || Ze
        ? (typeof v == 'function' && (Cu(n, t, v, r), (s = n.memoizedState)),
    ...
    i !== m || p !== w || ce.current || Ze
      ? (typeof g == 'function' && (Cu(n, t, g, r), (w = n.memoizedState)),
...
function Ri(e, n, t, r, l) {
  return bn(), io(l), (n.flags |= 256), le(e, n, t, r), n.child;
}
...
function id(e, n, t) {
  ...
  switch ((oo(n), n.tag)) {
    ...
    case 4:
      return (
        nt(), Lu(e, n), e === null && $t(n.stateNode.containerInfo), ne(n), null
      );
    case 10:
...
function cd(e, n) {
  ...
  for (vu = { focusedElem: e, selectionRange: t }, Ir = !1, S = n; S !== null; )
...
function Fa(e) {
  ...
  n !== null && ((e.alternate = null), Fa(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[Vt], delete n[gu], delete n[Kf], delete n[Yf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Re(e, n, t, r) {
  if (50 < Tt) throw ((Tt = 0), (Fu = null), Error(y(185)));
  Gt(e, t, r),
    (!(R & 2) || e !== Z) &&
...
function de(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Yo(t), n === 1))
      e.tag === 0 ? Xf($i.bind(null, e)) : Gs($i.bind(null, e)),
        Wf(function () {
          !(R & 6) && vn();
        }),
        (t = null);
...
function Va(e, n) {
  ...
  if (n !== 0) {
    if (
      (n === 2 && ((l = au(e)), l !== 0 && ((r = l), (n = ju(e, l)))), n === 1)
    )
      throw ((t = Yt), Cn(e, 0), qe(e, r), de(e, W()), t);
    if (n === 6) qe(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 3:
          if (
            (qe(e, r), (r & 130023424) === r && ((n = xo + 500 - W()), 10 < n))
          ) {
            if (Dr(e, 0) !== 0) break;
            ...
            e.timeoutHandle = yu(wn.bind(null, e, se, Ue), n);
            break;
          }
          wn(e, se, Ue);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = yu(wn.bind(null, e, se, Ue), r);
            break;
          }
          wn(e, se, Ue);
          break;
...
function $i(e) {
  ...
  if (t === 1) throw ((t = Yt), Cn(e, 0), qe(e, n), de(e, W()), t);
...
function zo() {
  (Y === 0 || Y === 3 || Y === 2) && (Y = 4),
    Z === null || (!(zn & 268435455) && !(cl & 268435455)) || qe(Z, q);
}
function qr(e, n) {
  var t = R;
  R |= 2;
...
Ya = function (e, n, t) {
  ...
  else (ae = !1), j && n.flags & 1048576 && Zs(n, Br, n.index);
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((n.tag = 1),
            ...
            _u(n, r, e, t),
            (n = Nu(null, n, r, !0, u, t)))
          : ((n.tag = 0), j && u && uo(n), le(null, n, l, t), (n = n.child)),
        n
      );
    case 16:
      r = n.elementType;
...
function Tr(e, n, t, r, l, u) {
  ...
  if (((r = e), typeof e == 'function')) To(e) && (o = 1);
    ...
    e: switch (e) {
      ...
      case Xl:
        return (
          (e = Se(12, t, n, l | 2)), (e.elementType = Xl), (e.lanes = u), e
        );
      case Gl:
        return (e = Se(13, t, n, l)), (e.elementType = Gl), (e.lanes = u), e;
      case Zl:
        return (e = Se(19, t, n, l)), (e.elementType = Zl), (e.lanes = u), e;
      case rs:
        return fl(t, l, u, n);
      default:
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Ju(n, t | 1), de(n, W()), !(R & 6) && ((rt = W() + 500), vn()));
      }
      break;
    case 13:
      Tn(function () {
...
ms = Po;
vs = Tn;
var Pd = { usingClientEntryPoint: !1, Events: [Jt, Un, ul, ds, ps, Po] },
  ht = {
...
var qa,
  Hi = Ql;
(qa = Hi.createRoot), Hi.hydrateRoot;
function zd() {
  const [e, n] = Lt.useState(0);
  return be.jsxs('div', {
    children: [
      be.jsx('h1', { children: 'This is Layout Component111122' }),
      be.jsxs('div', {
        children: [
          e,
          be.jsx('button', { onClick: () => n(e + 1), children: 'Add Count' })
        ]
      })
    ]
  });
